    ...
    return (
      <div>
        <h2 id="social-security-benefits-heading">
          <Translate contentKey="rosterServer2App.socialSecurityBenefits.home.title">Social Security Benefits</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.socialSecurityBenefits.home.createLabel">Create new Social Security Benefits</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {socialSecurityBenefitsList && socialSecurityBenefitsList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('code')}>
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th>
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.emp">Emp</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.socialSecurityBenefits.home.notFound">No Social Security Benefits found</Translate>
            </div>
          )}
        </div>

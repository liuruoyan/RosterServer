...
public class EnumAccountTypeResource {
    ...
    public ResponseEntity<List<EnumAccountTypeDTO>> getAllEnumAccountTypes(EnumAccountTypeCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

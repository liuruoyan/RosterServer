    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumPfType.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumPfType.home.createOrEditLabel">Create or edit a EnumPfType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumPfTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-pf-type-valuez">
                    <Translate contentKey="rosterServer2App.enumPfType.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-pf-type-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-pf-type-orderz">
                    <Translate contentKey="rosterServer2App.enumPfType.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="tenentCodeLabel" for="enum-pf-type-tenentCode">
                    <Translate contentKey="rosterServer2App.enumPfType.tenentCode">Tenent Code</Translate>
                  </Label>
                  <AvField id="enum-pf-type-tenentCode" type="text" name="tenentCode" />
                </AvGroup>
                <AvGroup>
                  <Label for="enum-pf-type-parent">
                    <Translate contentKey="rosterServer2App.enumPfType.parent">Parent</Translate>
                  </Label>

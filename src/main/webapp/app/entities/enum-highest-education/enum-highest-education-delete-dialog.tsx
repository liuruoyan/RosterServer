  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="rosterServer2App.enumHighestEducation.delete.question">
          <Translate contentKey="rosterServer2App.enumHighestEducation.delete.question" interpolate={{ id: enumHighestEducationEntity.id }}>

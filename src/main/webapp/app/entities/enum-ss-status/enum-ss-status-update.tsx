    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumSsStatus.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumSsStatus.home.createOrEditLabel">Create or edit a EnumSsStatus</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumSsStatusEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-ss-status-valuez">
                    <Translate contentKey="rosterServer2App.enumSsStatus.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-ss-status-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-ss-status-orderz">
                    <Translate contentKey="rosterServer2App.enumSsStatus.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="tenentCodeLabel" for="enum-ss-status-tenentCode">
                    <Translate contentKey="rosterServer2App.enumSsStatus.tenentCode">Tenent Code</Translate>
                  </Label>
                  <AvField id="enum-ss-status-tenentCode" type="text" name="tenentCode" />
                </AvGroup>
                <AvGroup>
                  <Label for="enum-ss-status-parent">
                    <Translate contentKey="rosterServer2App.enumSsStatus.parent">Parent</Translate>
                  </Label>

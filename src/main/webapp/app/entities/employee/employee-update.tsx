    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.employee.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : employeeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="employee-code">
                    <Translate contentKey="rosterServer2App.employee.code">Code</Translate>
                  </Label>
                  <AvField id="employee-code" type="text" name="code" />
                  <UncontrolledTooltip target="codeLabel">
                    <Translate contentKey="rosterServer2App.employee.help.code" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="nameLabel" for="employee-name">
                    <Translate contentKey="rosterServer2App.employee.name">Name</Translate>
                  </Label>
                  <AvField id="employee-name" type="text" name="name" />
                  <UncontrolledTooltip target="nameLabel">
                    <Translate contentKey="rosterServer2App.employee.help.name" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="idNumberLabel" for="employee-idNumber">
                    <Translate contentKey="rosterServer2App.employee.idNumber">Id Number</Translate>
                  </Label>
                  <AvField id="employee-idNumber" type="text" name="idNumber" />
                  <UncontrolledTooltip target="idNumberLabel">
                    <Translate contentKey="rosterServer2App.employee.help.idNumber" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="phoneLabel" for="employee-phone">
                    <Translate contentKey="rosterServer2App.employee.phone">Phone</Translate>
                  </Label>
                  <AvField id="employee-phone" type="text" name="phone" />
                  <UncontrolledTooltip target="phoneLabel">
                    <Translate contentKey="rosterServer2App.employee.help.phone" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="hireDateLabel" for="employee-hireDate">
                    <Translate contentKey="rosterServer2App.employee.hireDate">Hire Date</Translate>
                  </Label>
                  <AvField id="employee-hireDate" type="date" className="form-control" name="hireDate" />
                  <UncontrolledTooltip target="hireDateLabel">
                    <Translate contentKey="rosterServer2App.employee.help.hireDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="jobGradeLabel" for="employee-jobGrade">
                    <Translate contentKey="rosterServer2App.employee.jobGrade">Job Grade</Translate>
                  </Label>
                  <AvField id="employee-jobGrade" type="text" name="jobGrade" />
                  <UncontrolledTooltip target="jobGradeLabel">
                    <Translate contentKey="rosterServer2App.employee.help.jobGrade" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="positionLabel" for="employee-position">
                    <Translate contentKey="rosterServer2App.employee.position">Position</Translate>
                  </Label>
                  <AvField id="employee-position" type="text" name="position" />
                  <UncontrolledTooltip target="positionLabel">
                    <Translate contentKey="rosterServer2App.employee.help.position" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="jobLabel" for="employee-job">
                    <Translate contentKey="rosterServer2App.employee.job">Job</Translate>
                  </Label>
                  <AvField id="employee-job" type="text" name="job" />
                  <UncontrolledTooltip target="jobLabel">
                    <Translate contentKey="rosterServer2App.employee.help.job" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="deptNameLabel" for="employee-deptName">
                    <Translate contentKey="rosterServer2App.employee.deptName">Dept Name</Translate>
                  </Label>
                  <AvField id="employee-deptName" type="text" name="deptName" />
                  <UncontrolledTooltip target="deptNameLabel">
                    <Translate contentKey="rosterServer2App.employee.help.deptName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="empNoLabel" for="employee-empNo">
                    <Translate contentKey="rosterServer2App.employee.empNo">Emp No</Translate>
                  </Label>
                  <AvField id="employee-empNo" type="text" name="empNo" />
                  <UncontrolledTooltip target="empNoLabel">
                    <Translate contentKey="rosterServer2App.employee.help.empNo" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="seniorityLabel" for="employee-seniority">
                    <Translate contentKey="rosterServer2App.employee.seniority">Seniority</Translate>
                  </Label>
                  <AvField id="employee-seniority" type="string" className="form-control" name="seniority" />
                  <UncontrolledTooltip target="seniorityLabel">
                    <Translate contentKey="rosterServer2App.employee.help.seniority" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="contractorLabel" for="employee-contractor">
                    <Translate contentKey="rosterServer2App.employee.contractor">Contractor</Translate>
                  </Label>
                  <AvField id="employee-contractor" type="text" name="contractor" />
                  <UncontrolledTooltip target="contractorLabel">
                    <Translate contentKey="rosterServer2App.employee.help.contractor" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="birthTypeLabel" for="employee-birthType">
                    <Translate contentKey="rosterServer2App.employee.birthType">Birth Type</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="LUNAR">{translate('rosterServer2App.BirthType.LUNAR')}</option>
                    <option value="CALENDAR">{translate('rosterServer2App.BirthType.CALENDAR')}</option>
                  </AvInput>
                  <UncontrolledTooltip target="birthTypeLabel">
                    <Translate contentKey="rosterServer2App.employee.help.birthType" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="birthdayLabel" for="employee-birthday">
                    <Translate contentKey="rosterServer2App.employee.birthday">Birthday</Translate>
                  </Label>
                  <AvField id="employee-birthday" type="date" className="form-control" name="birthday" />
                  <UncontrolledTooltip target="birthdayLabel">
                    <Translate contentKey="rosterServer2App.employee.help.birthday" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="workLocLabel" for="employee-workLoc">
                    <Translate contentKey="rosterServer2App.employee.workLoc">Work Loc</Translate>
                  </Label>
                  <AvField id="employee-workLoc" type="text" name="workLoc" />
                  <UncontrolledTooltip target="workLocLabel">
                    <Translate contentKey="rosterServer2App.employee.help.workLoc" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="contactAddrLabel" for="employee-contactAddr">
                    <Translate contentKey="rosterServer2App.employee.contactAddr">Contact Addr</Translate>
                  </Label>
                  <AvField id="employee-contactAddr" type="text" name="contactAddr" />
                  <UncontrolledTooltip target="contactAddrLabel">
                    <Translate contentKey="rosterServer2App.employee.help.contactAddr" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="nationalityLabel" for="employee-nationality">
                    <Translate contentKey="rosterServer2App.employee.nationality">Nationality</Translate>
                  </Label>
                  <AvField id="employee-nationality" type="text" name="nationality" />
                  <UncontrolledTooltip target="nationalityLabel">
                    <Translate contentKey="rosterServer2App.employee.help.nationality" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="firstNameLabel" for="employee-firstName">
                    <Translate contentKey="rosterServer2App.employee.firstName">First Name</Translate>
                  </Label>
                  <AvField id="employee-firstName" type="text" name="firstName" />
                  <UncontrolledTooltip target="firstNameLabel">
                    <Translate contentKey="rosterServer2App.employee.help.firstName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="lastNameLabel" for="employee-lastName">
                    <Translate contentKey="rosterServer2App.employee.lastName">Last Name</Translate>
                  </Label>
                  <AvField id="employee-lastName" type="text" name="lastName" />
                  <UncontrolledTooltip target="lastNameLabel">
                    <Translate contentKey="rosterServer2App.employee.help.lastName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="othersLabel" for="employee-others">
                    <Translate contentKey="rosterServer2App.employee.others">Others</Translate>
                  </Label>
                  <AvField id="employee-others" type="text" name="others" />
                  <UncontrolledTooltip target="othersLabel">
                    <Translate contentKey="rosterServer2App.employee.help.others" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isSelfVerifyLabel" check>
                    <AvInput id="employee-isSelfVerify" type="checkbox" className="form-control" name="isSelfVerify" />
                    <Translate contentKey="rosterServer2App.employee.isSelfVerify">Is Self Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isSelfVerifyLabel">
                    <Translate contentKey="rosterServer2App.employee.help.isSelfVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isHrVerifyLabel" check>
                    <AvInput id="employee-isHrVerify" type="checkbox" className="form-control" name="isHrVerify" />
                    <Translate contentKey="rosterServer2App.employee.isHrVerify">Is Hr Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isHrVerifyLabel">
                    <Translate contentKey="rosterServer2App.employee.help.isHrVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="employee-status">
                    <Translate contentKey="rosterServer2App.employee.status">Status</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee-idType">
                    <Translate contentKey="rosterServer2App.employee.idType">Id Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee-contractType">
                    <Translate contentKey="rosterServer2App.employee.contractType">Contract Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee-empType">
                    <Translate contentKey="rosterServer2App.employee.empType">Emp Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee-gender">
                    <Translate contentKey="rosterServer2App.employee.gender">Gender</Translate>
                  </Label>

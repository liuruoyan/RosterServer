    ...
    return (
      <div>
        <h2 id="enum-emp-taxer-type-heading">
          <Translate contentKey="rosterServer2App.enumEmpTaxerType.home.title">Enum Emp Taxer Types</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.enumEmpTaxerType.home.createLabel">Create new Enum Emp Taxer Type</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {enumEmpTaxerTypeList && enumEmpTaxerTypeList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('valuez')}>
                    <Translate contentKey="rosterServer2App.enumEmpTaxerType.valuez">Valuez</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('orderz')}>
                    <Translate contentKey="rosterServer2App.enumEmpTaxerType.orderz">Orderz</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('tenentCode')}>
                    <Translate contentKey="rosterServer2App.enumEmpTaxerType.tenentCode">Tenent Code</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="rosterServer2App.enumEmpTaxerType.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.enumEmpTaxerType.home.notFound">No Enum Emp Taxer Types found</Translate>
            </div>
          )}
        </div>

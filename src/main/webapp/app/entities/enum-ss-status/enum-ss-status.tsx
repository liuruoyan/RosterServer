    ...
    return (
      <div>
        <h2 id="enum-ss-status-heading">
          <Translate contentKey="rosterServer2App.enumSsStatus.home.title">Enum Ss Statuses</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.enumSsStatus.home.createLabel">Create new Enum Ss Status</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {enumSsStatusList && enumSsStatusList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('valuez')}>
                    <Translate contentKey="rosterServer2App.enumSsStatus.valuez">Valuez</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('orderz')}>
                    <Translate contentKey="rosterServer2App.enumSsStatus.orderz">Orderz</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('tenentCode')}>
                    <Translate contentKey="rosterServer2App.enumSsStatus.tenentCode">Tenent Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="rosterServer2App.enumSsStatus.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.enumSsStatus.home.notFound">No Enum Ss Statuses found</Translate>
            </div>
          )}
        </div>

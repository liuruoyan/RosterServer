    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumPfPayScheme.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumPfPayScheme.home.createOrEditLabel">Create or edit a EnumPfPayScheme</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumPfPaySchemeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-pf-pay-scheme-valuez">
                    <Translate contentKey="rosterServer2App.enumPfPayScheme.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-pf-pay-scheme-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-pf-pay-scheme-orderz">
                    <Translate contentKey="rosterServer2App.enumPfPayScheme.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-pf-pay-scheme-parent">
                    <Translate contentKey="rosterServer2App.enumPfPayScheme.parent">Parent</Translate>
                  </Label>

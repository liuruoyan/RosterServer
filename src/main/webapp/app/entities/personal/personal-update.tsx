    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.personal.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.personal.home.createOrEditLabel">Create or edit a Personal</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : personalEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="personal-code">
                    <Translate contentKey="rosterServer2App.personal.code">Code</Translate>
                  </Label>
                  <AvField id="personal-code" type="text" name="code" />
                  <UncontrolledTooltip target="codeLabel">
                    <Translate contentKey="rosterServer2App.personal.help.code" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="stageNameLabel" for="personal-stageName">
                    <Translate contentKey="rosterServer2App.personal.stageName">Stage Name</Translate>
                  </Label>
                  <AvField id="personal-stageName" type="text" name="stageName" />
                  <UncontrolledTooltip target="stageNameLabel">
                    <Translate contentKey="rosterServer2App.personal.help.stageName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="idNameLabel" for="personal-idName">
                    <Translate contentKey="rosterServer2App.personal.idName">Id Name</Translate>
                  </Label>
                  <AvField id="personal-idName" type="text" name="idName" />
                  <UncontrolledTooltip target="idNameLabel">
                    <Translate contentKey="rosterServer2App.personal.help.idName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="nationLabel" for="personal-nation">
                    <Translate contentKey="rosterServer2App.personal.nation">Nation</Translate>
                  </Label>
                  <AvField id="personal-nation" type="text" name="nation" />
                  <UncontrolledTooltip target="nationLabel">
                    <Translate contentKey="rosterServer2App.personal.help.nation" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="accountLocLabel" for="personal-accountLoc">
                    <Translate contentKey="rosterServer2App.personal.accountLoc">Account Loc</Translate>
                  </Label>
                  <AvField id="personal-accountLoc" type="text" name="accountLoc" />
                  <UncontrolledTooltip target="accountLocLabel">
                    <Translate contentKey="rosterServer2App.personal.help.accountLoc" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="nativePlaceLabel" for="personal-nativePlace">
                    <Translate contentKey="rosterServer2App.personal.nativePlace">Native Place</Translate>
                  </Label>
                  <AvField id="personal-nativePlace" type="text" name="nativePlace" />
                  <UncontrolledTooltip target="nativePlaceLabel">
                    <Translate contentKey="rosterServer2App.personal.help.nativePlace" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="currentAddrLabel" for="personal-currentAddr">
                    <Translate contentKey="rosterServer2App.personal.currentAddr">Current Addr</Translate>
                  </Label>
                  <AvField id="personal-currentAddr" type="text" name="currentAddr" />
                  <UncontrolledTooltip target="currentAddrLabel">
                    <Translate contentKey="rosterServer2App.personal.help.currentAddr" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="spouseNameLabel" for="personal-spouseName">
                    <Translate contentKey="rosterServer2App.personal.spouseName">Spouse Name</Translate>
                  </Label>
                  <AvField id="personal-spouseName" type="text" name="spouseName" />
                  <UncontrolledTooltip target="spouseNameLabel">
                    <Translate contentKey="rosterServer2App.personal.help.spouseName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="childNameLabel" for="personal-childName">
                    <Translate contentKey="rosterServer2App.personal.childName">Child Name</Translate>
                  </Label>
                  <AvField id="personal-childName" type="text" name="childName" />
                  <UncontrolledTooltip target="childNameLabel">
                    <Translate contentKey="rosterServer2App.personal.help.childName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="bloodTypeLabel" for="personal-bloodType">
                    <Translate contentKey="rosterServer2App.personal.bloodType">Blood Type</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="A">{translate('rosterServer2App.BloodType.A')}</option>
                    <option value="B">{translate('rosterServer2App.BloodType.B')}</option>
                    <option value="O">{translate('rosterServer2App.BloodType.O')}</option>
                    <option value="AB">{translate('rosterServer2App.BloodType.AB')}</option>
                  </AvInput>
                  <UncontrolledTooltip target="bloodTypeLabel">
                    <Translate contentKey="rosterServer2App.personal.help.bloodType" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="emergencyContactNameLabel" for="personal-emergencyContactName">
                    <Translate contentKey="rosterServer2App.personal.emergencyContactName">Emergency Contact Name</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="emergencyContactNameLabel">
                    <Translate contentKey="rosterServer2App.personal.help.emergencyContactName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="emergencyContactPhoneLabel" for="personal-emergencyContactPhone">
                    <Translate contentKey="rosterServer2App.personal.emergencyContactPhone">Emergency Contact Phone</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="emergencyContactPhoneLabel">
                    <Translate contentKey="rosterServer2App.personal.help.emergencyContactPhone" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="qqLabel" for="personal-qq">
                    <Translate contentKey="rosterServer2App.personal.qq">Qq</Translate>
                  </Label>
                  <AvField id="personal-qq" type="text" name="qq" />
                  <UncontrolledTooltip target="qqLabel">
                    <Translate contentKey="rosterServer2App.personal.help.qq" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="wechatLabel" for="personal-wechat">
                    <Translate contentKey="rosterServer2App.personal.wechat">Wechat</Translate>
                  </Label>
                  <AvField id="personal-wechat" type="text" name="wechat" />
                  <UncontrolledTooltip target="wechatLabel">
                    <Translate contentKey="rosterServer2App.personal.help.wechat" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="personalEmailLabel" for="personal-personalEmail">
                    <Translate contentKey="rosterServer2App.personal.personalEmail">Personal Email</Translate>
                  </Label>
                  <AvField id="personal-personalEmail" type="text" name="personalEmail" />
                  <UncontrolledTooltip target="personalEmailLabel">
                    <Translate contentKey="rosterServer2App.personal.help.personalEmail" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="remarkLabel" for="personal-remark">
                    <Translate contentKey="rosterServer2App.personal.remark">Remark</Translate>
                  </Label>
                  <AvField id="personal-remark" type="text" name="remark" />
                  <UncontrolledTooltip target="remarkLabel">
                    <Translate contentKey="rosterServer2App.personal.help.remark" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="othersLabel" for="personal-others">
                    <Translate contentKey="rosterServer2App.personal.others">Others</Translate>
                  </Label>
                  <AvField id="personal-others" type="text" name="others" />
                  <UncontrolledTooltip target="othersLabel">
                    <Translate contentKey="rosterServer2App.personal.help.others" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isSelfVerifyLabel" check>
                    <AvInput id="personal-isSelfVerify" type="checkbox" className="form-control" name="isSelfVerify" />
                    <Translate contentKey="rosterServer2App.personal.isSelfVerify">Is Self Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isSelfVerifyLabel">
                    <Translate contentKey="rosterServer2App.personal.help.isSelfVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isHrVerifyLabel" check>
                    <AvInput id="personal-isHrVerify" type="checkbox" className="form-control" name="isHrVerify" />
                    <Translate contentKey="rosterServer2App.personal.isHrVerify">Is Hr Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isHrVerifyLabel">
                    <Translate contentKey="rosterServer2App.personal.help.isHrVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="personal-accountType">
                    <Translate contentKey="rosterServer2App.personal.accountType">Account Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="personal-highestEducation">
                    <Translate contentKey="rosterServer2App.personal.highestEducation">Highest Education</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="personal-politicsStatus">
                    <Translate contentKey="rosterServer2App.personal.politicsStatus">Politics Status</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="personal-maritalStatus">
                    <Translate contentKey="rosterServer2App.personal.maritalStatus">Marital Status</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="personal-emp">
                    <Translate contentKey="rosterServer2App.personal.emp">Emp</Translate>
                  </Label>

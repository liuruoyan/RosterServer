...
public class EnumEmpTypeResource {
    ...
    public ResponseEntity<List<EnumEmpTypeDTO>> getAllEnumEmpTypes(EnumEmpTypeCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

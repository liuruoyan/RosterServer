    ...
    return (
      <div>
        <h2 id="enum-ss-pay-scheme-heading">
          <Translate contentKey="rosterServer2App.enumSsPayScheme.home.title">Enum Ss Pay Schemes</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.enumSsPayScheme.home.createLabel">Create new Enum Ss Pay Scheme</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {enumSsPaySchemeList && enumSsPaySchemeList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('valuez')}>
                    <Translate contentKey="rosterServer2App.enumSsPayScheme.valuez">Valuez</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('orderz')}>
                    <Translate contentKey="rosterServer2App.enumSsPayScheme.orderz">Orderz</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('tenentCode')}>
                    <Translate contentKey="rosterServer2App.enumSsPayScheme.tenentCode">Tenent Code</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="rosterServer2App.enumSsPayScheme.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.enumSsPayScheme.home.notFound">No Enum Ss Pay Schemes found</Translate>
            </div>
          )}
        </div>

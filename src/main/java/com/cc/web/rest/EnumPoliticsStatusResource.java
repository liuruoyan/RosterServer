...
public class EnumPoliticsStatusResource {
    ...
    public ResponseEntity<List<EnumPoliticsStatusDTO>> getAllEnumPoliticsStatuses(EnumPoliticsStatusCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

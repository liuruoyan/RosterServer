    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.payCard.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.payCard.home.createOrEditLabel">Create or edit a PayCard</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : payCardEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="pay-card-code">
                    <Translate contentKey="rosterServer2App.payCard.code">Code</Translate>
                  </Label>
                  <AvField id="pay-card-code" type="text" name="code" />
                  <UncontrolledTooltip target="codeLabel">
                    <Translate contentKey="rosterServer2App.payCard.help.code" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="branchLabel" for="pay-card-branch">
                    <Translate contentKey="rosterServer2App.payCard.branch">Branch</Translate>
                  </Label>
                  <AvField id="pay-card-branch" type="text" name="branch" />
                  <UncontrolledTooltip target="branchLabel">
                    <Translate contentKey="rosterServer2App.payCard.help.branch" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="accountNameLabel" for="pay-card-accountName">
                    <Translate contentKey="rosterServer2App.payCard.accountName">Account Name</Translate>
                  </Label>
                  <AvField id="pay-card-accountName" type="text" name="accountName" />
                  <UncontrolledTooltip target="accountNameLabel">
                    <Translate contentKey="rosterServer2App.payCard.help.accountName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="bankAccountLabel" for="pay-card-bankAccount">
                    <Translate contentKey="rosterServer2App.payCard.bankAccount">Bank Account</Translate>
                  </Label>
                  <AvField id="pay-card-bankAccount" type="text" name="bankAccount" />
                  <UncontrolledTooltip target="bankAccountLabel">
                    <Translate contentKey="rosterServer2App.payCard.help.bankAccount" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isSelfVerifyLabel" check>
                    <AvInput id="pay-card-isSelfVerify" type="checkbox" className="form-control" name="isSelfVerify" />
                    <Translate contentKey="rosterServer2App.payCard.isSelfVerify">Is Self Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isSelfVerifyLabel">
                    <Translate contentKey="rosterServer2App.payCard.help.isSelfVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isHrVerifyLabel" check>
                    <AvInput id="pay-card-isHrVerify" type="checkbox" className="form-control" name="isHrVerify" />
                    <Translate contentKey="rosterServer2App.payCard.isHrVerify">Is Hr Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isHrVerifyLabel">
                    <Translate contentKey="rosterServer2App.payCard.help.isHrVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="pay-card-depositBank">
                    <Translate contentKey="rosterServer2App.payCard.depositBank">Deposit Bank</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="pay-card-emp">
                    <Translate contentKey="rosterServer2App.payCard.emp">Emp</Translate>
                  </Label>

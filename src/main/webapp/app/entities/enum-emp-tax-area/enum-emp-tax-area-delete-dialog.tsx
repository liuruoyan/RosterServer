  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="rosterServer2App.enumEmpTaxArea.delete.question">
          <Translate contentKey="rosterServer2App.enumEmpTaxArea.delete.question" interpolate={{ id: enumEmpTaxAreaEntity.id }}>

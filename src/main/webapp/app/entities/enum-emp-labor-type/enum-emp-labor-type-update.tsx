    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumEmpLaborType.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumEmpLaborType.home.createOrEditLabel">Create or edit a EnumEmpLaborType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumEmpLaborTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-emp-labor-type-valuez">
                    <Translate contentKey="rosterServer2App.enumEmpLaborType.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-emp-labor-type-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-emp-labor-type-orderz">
                    <Translate contentKey="rosterServer2App.enumEmpLaborType.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-emp-labor-type-parent">
                    <Translate contentKey="rosterServer2App.enumEmpLaborType.parent">Parent</Translate>
                  </Label>

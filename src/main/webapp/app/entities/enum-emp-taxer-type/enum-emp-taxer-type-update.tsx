    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumEmpTaxerType.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumEmpTaxerType.home.createOrEditLabel">Create or edit a EnumEmpTaxerType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumEmpTaxerTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-emp-taxer-type-valuez">
                    <Translate contentKey="rosterServer2App.enumEmpTaxerType.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-emp-taxer-type-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-emp-taxer-type-orderz">
                    <Translate contentKey="rosterServer2App.enumEmpTaxerType.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-emp-taxer-type-parent">
                    <Translate contentKey="rosterServer2App.enumEmpTaxerType.parent">Parent</Translate>
                  </Label>

    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.educationExperience.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.educationExperience.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : educationExperienceEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="education-experience-code">
                    <Translate contentKey="rosterServer2App.educationExperience.code">Code</Translate>
                  </Label>
                  <AvField id="education-experience-code" type="text" name="code" />
                  <UncontrolledTooltip target="codeLabel">
                    <Translate contentKey="rosterServer2App.educationExperience.help.code" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="nameLabel" for="education-experience-name">
                    <Translate contentKey="rosterServer2App.educationExperience.name">Name</Translate>
                  </Label>
                  <AvField id="education-experience-name" type="text" name="name" />
                  <UncontrolledTooltip target="nameLabel">
                    <Translate contentKey="rosterServer2App.educationExperience.help.name" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="phoneLabel" for="education-experience-phone">
                    <Translate contentKey="rosterServer2App.educationExperience.phone">Phone</Translate>
                  </Label>
                  <AvField id="education-experience-phone" type="text" name="phone" />
                  <UncontrolledTooltip target="phoneLabel">
                    <Translate contentKey="rosterServer2App.educationExperience.help.phone" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="schoolLabel" for="education-experience-school">
                    <Translate contentKey="rosterServer2App.educationExperience.school">School</Translate>
                  </Label>
                  <AvField id="education-experience-school" type="text" name="school" />
                  <UncontrolledTooltip target="schoolLabel">
                    <Translate contentKey="rosterServer2App.educationExperience.help.school" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="majorLabel" for="education-experience-major">
                    <Translate contentKey="rosterServer2App.educationExperience.major">Major</Translate>
                  </Label>
                  <AvField id="education-experience-major" type="text" name="major" />
                  <UncontrolledTooltip target="majorLabel">
                    <Translate contentKey="rosterServer2App.educationExperience.help.major" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="inDateLabel" for="education-experience-inDate">
                    <Translate contentKey="rosterServer2App.educationExperience.inDate">In Date</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="inDateLabel">
                    <Translate contentKey="rosterServer2App.educationExperience.help.inDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="graduationDateLabel" for="education-experience-graduationDate">
                    <Translate contentKey="rosterServer2App.educationExperience.graduationDate">Graduation Date</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="graduationDateLabel">
                    <Translate contentKey="rosterServer2App.educationExperience.help.graduationDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="inceptionLabel" check>
                    ...
                    <Translate contentKey="rosterServer2App.educationExperience.inception">Inception</Translate>
                  </Label>
                  <UncontrolledTooltip target="inceptionLabel">
                    <Translate contentKey="rosterServer2App.educationExperience.help.inception" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isSelfVerifyLabel" check>
                    ...
                    <Translate contentKey="rosterServer2App.educationExperience.isSelfVerify">Is Self Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isSelfVerifyLabel">
                    <Translate contentKey="rosterServer2App.educationExperience.help.isSelfVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isHrVerifyLabel" check>
                    ...
                    <Translate contentKey="rosterServer2App.educationExperience.isHrVerify">Is Hr Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isHrVerifyLabel">
                    <Translate contentKey="rosterServer2App.educationExperience.help.isHrVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="education-experience-education">
                    <Translate contentKey="rosterServer2App.educationExperience.education">Education</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="education-experience-emp">
                    <Translate contentKey="rosterServer2App.educationExperience.emp">Emp</Translate>
                  </Label>

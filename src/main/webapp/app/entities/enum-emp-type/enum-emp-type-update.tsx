    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumEmpType.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumEmpType.home.createOrEditLabel">Create or edit a EnumEmpType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumEmpTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-emp-type-valuez">
                    <Translate contentKey="rosterServer2App.enumEmpType.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-emp-type-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-emp-type-orderz">
                    <Translate contentKey="rosterServer2App.enumEmpType.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="tenentCodeLabel" for="enum-emp-type-tenentCode">
                    <Translate contentKey="rosterServer2App.enumEmpType.tenentCode">Tenent Code</Translate>
                  </Label>
                  <AvField id="enum-emp-type-tenentCode" type="text" name="tenentCode" />
                </AvGroup>
                <AvGroup>
                  <Label for="enum-emp-type-parent">
                    <Translate contentKey="rosterServer2App.enumEmpType.parent">Parent</Translate>
                  </Label>

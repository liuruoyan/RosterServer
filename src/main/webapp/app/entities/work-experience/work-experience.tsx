    ...
    return (
      <div>
        <h2 id="work-experience-heading">
          <Translate contentKey="rosterServer2App.workExperience.home.title">Work Experiences</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.workExperience.home.createLabel">Create new Work Experience</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {workExperienceList && workExperienceList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('code')}>
                    <Translate contentKey="rosterServer2App.workExperience.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('eName')}>
                    <Translate contentKey="rosterServer2App.workExperience.eName">E Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('phoneNum')}>
                    <Translate contentKey="rosterServer2App.workExperience.phoneNum">Phone Num</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('company')}>
                    <Translate contentKey="rosterServer2App.workExperience.company">Company</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('job')}>
                    <Translate contentKey="rosterServer2App.workExperience.job">Job</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('jobDesc')}>
                    <Translate contentKey="rosterServer2App.workExperience.jobDesc">Job Desc</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('hireDate')}>
                    <Translate contentKey="rosterServer2App.workExperience.hireDate">Hire Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('leaveDate')}>
                    <Translate contentKey="rosterServer2App.workExperience.leaveDate">Leave Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th>
                    <Translate contentKey="rosterServer2App.workExperience.emp">Emp</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.workExperience.home.notFound">No Work Experiences found</Translate>
            </div>
          )}
        </div>

  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="rosterServer2App.enumPoliticsStatus.delete.question">
          <Translate contentKey="rosterServer2App.enumPoliticsStatus.delete.question" interpolate={{ id: enumPoliticsStatusEntity.id }}>

...
public class EnumHighestEducationResource {
    ...
    public ResponseEntity<List<EnumHighestEducationDTO>> getAllEnumHighestEducations(EnumHighestEducationCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

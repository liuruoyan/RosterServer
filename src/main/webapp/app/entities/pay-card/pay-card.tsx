    ...
    return (
      <div>
        <h2 id="pay-card-heading">
          <Translate contentKey="rosterServer2App.payCard.home.title">Pay Cards</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.payCard.home.createLabel">Create new Pay Card</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {payCardList && payCardList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('code')}>
                    <Translate contentKey="rosterServer2App.payCard.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('branch')}>
                    <Translate contentKey="rosterServer2App.payCard.branch">Branch</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('accountName')}>
                    <Translate contentKey="rosterServer2App.payCard.accountName">Account Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('bankAccount')}>
                    <Translate contentKey="rosterServer2App.payCard.bankAccount">Bank Account</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('isSelfVerify')}>
                    <Translate contentKey="rosterServer2App.payCard.isSelfVerify">Is Self Verify</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('isHrVerify')}>
                    <Translate contentKey="rosterServer2App.payCard.isHrVerify">Is Hr Verify</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="rosterServer2App.payCard.depositBank">Deposit Bank</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="rosterServer2App.payCard.emp">Emp</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.payCard.home.notFound">No Pay Cards found</Translate>
            </div>
          )}
        </div>

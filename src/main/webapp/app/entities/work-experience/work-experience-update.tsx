    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.workExperience.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.workExperience.home.createOrEditLabel">Create or edit a WorkExperience</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : workExperienceEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="work-experience-code">
                    <Translate contentKey="rosterServer2App.workExperience.code">Code</Translate>
                  </Label>
                  <AvField id="work-experience-code" type="text" name="code" />
                  <UncontrolledTooltip target="codeLabel">
                    <Translate contentKey="rosterServer2App.workExperience.help.code" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="eNameLabel" for="work-experience-eName">
                    <Translate contentKey="rosterServer2App.workExperience.eName">E Name</Translate>
                  </Label>
                  <AvField id="work-experience-eName" type="text" name="eName" />
                  <UncontrolledTooltip target="eNameLabel">
                    <Translate contentKey="rosterServer2App.workExperience.help.eName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="phoneNumLabel" for="work-experience-phoneNum">
                    <Translate contentKey="rosterServer2App.workExperience.phoneNum">Phone Num</Translate>
                  </Label>
                  <AvField id="work-experience-phoneNum" type="text" name="phoneNum" />
                  <UncontrolledTooltip target="phoneNumLabel">
                    <Translate contentKey="rosterServer2App.workExperience.help.phoneNum" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="companyLabel" for="work-experience-company">
                    <Translate contentKey="rosterServer2App.workExperience.company">Company</Translate>
                  </Label>
                  <AvField id="work-experience-company" type="text" name="company" />
                  <UncontrolledTooltip target="companyLabel">
                    <Translate contentKey="rosterServer2App.workExperience.help.company" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="jobLabel" for="work-experience-job">
                    <Translate contentKey="rosterServer2App.workExperience.job">Job</Translate>
                  </Label>
                  <AvField id="work-experience-job" type="text" name="job" />
                  <UncontrolledTooltip target="jobLabel">
                    <Translate contentKey="rosterServer2App.workExperience.help.job" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="jobDescLabel" for="work-experience-jobDesc">
                    <Translate contentKey="rosterServer2App.workExperience.jobDesc">Job Desc</Translate>
                  </Label>
                  <AvField id="work-experience-jobDesc" type="text" name="jobDesc" />
                  <UncontrolledTooltip target="jobDescLabel">
                    <Translate contentKey="rosterServer2App.workExperience.help.jobDesc" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="hireDateLabel" for="work-experience-hireDate">
                    <Translate contentKey="rosterServer2App.workExperience.hireDate">Hire Date</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="hireDateLabel">
                    <Translate contentKey="rosterServer2App.workExperience.help.hireDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="leaveDateLabel" for="work-experience-leaveDate">
                    <Translate contentKey="rosterServer2App.workExperience.leaveDate">Leave Date</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="leaveDateLabel">
                    <Translate contentKey="rosterServer2App.workExperience.help.leaveDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isSelfVerifyLabel" check>
                    ...
                    <Translate contentKey="rosterServer2App.workExperience.isSelfVerify">Is Self Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isSelfVerifyLabel">
                    <Translate contentKey="rosterServer2App.workExperience.help.isSelfVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isHrVerifyLabel" check>
                    <AvInput id="work-experience-isHrVerify" type="checkbox" className="form-control" name="isHrVerify" />
                    <Translate contentKey="rosterServer2App.workExperience.isHrVerify">Is Hr Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isHrVerifyLabel">
                    <Translate contentKey="rosterServer2App.workExperience.help.isHrVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="work-experience-emp">
                    <Translate contentKey="rosterServer2App.workExperience.emp">Emp</Translate>
                  </Label>

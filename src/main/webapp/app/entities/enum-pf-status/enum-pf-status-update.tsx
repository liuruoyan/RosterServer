    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumPfStatus.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumPfStatus.home.createOrEditLabel">Create or edit a EnumPfStatus</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumPfStatusEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-pf-status-valuez">
                    <Translate contentKey="rosterServer2App.enumPfStatus.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-pf-status-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-pf-status-orderz">
                    <Translate contentKey="rosterServer2App.enumPfStatus.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="tenentCodeLabel" for="enum-pf-status-tenentCode">
                    <Translate contentKey="rosterServer2App.enumPfStatus.tenentCode">Tenent Code</Translate>
                  </Label>
                  <AvField id="enum-pf-status-tenentCode" type="text" name="tenentCode" />
                </AvGroup>
                <AvGroup>
                  <Label for="enum-pf-status-parent">
                    <Translate contentKey="rosterServer2App.enumPfStatus.parent">Parent</Translate>
                  </Label>

    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.socialSecurityBenefits.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.socialSecurityBenefits.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : socialSecurityBenefitsEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="social-security-benefits-code">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.code">Code</Translate>
                  </Label>
                  <AvField id="social-security-benefits-code" type="text" name="code" />
                  <UncontrolledTooltip target="codeLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.code" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="pfAccountLabel" for="social-security-benefits-pfAccount">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.pfAccount">Pf Account</Translate>
                  </Label>
                  <AvField id="social-security-benefits-pfAccount" type="text" name="pfAccount" />
                  <UncontrolledTooltip target="pfAccountLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.pfAccount" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="spfAccountLabel" for="social-security-benefits-spfAccount">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.spfAccount">Spf Account</Translate>
                  </Label>
                  <AvField id="social-security-benefits-spfAccount" type="text" name="spfAccount" />
                  <UncontrolledTooltip target="spfAccountLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.spfAccount" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="pfStartMonthLabel" for="social-security-benefits-pfStartMonth">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.pfStartMonth">Pf Start Month</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="pfStartMonthLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.pfStartMonth" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="pfBaseLabel" for="social-security-benefits-pfBase">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.pfBase">Pf Base</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="pfBaseLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.pfBase" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="pfStopMonthLabel" for="social-security-benefits-pfStopMonth">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.pfStopMonth">Pf Stop Month</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="pfStopMonthLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.pfStopMonth" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="pfRemarkLabel" for="social-security-benefits-pfRemark">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.pfRemark">Pf Remark</Translate>
                  </Label>
                  <AvField id="social-security-benefits-pfRemark" type="text" name="pfRemark" />
                  <UncontrolledTooltip target="pfRemarkLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.pfRemark" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="ssAccountLabel" for="social-security-benefits-ssAccount">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.ssAccount">Ss Account</Translate>
                  </Label>
                  <AvField id="social-security-benefits-ssAccount" type="text" name="ssAccount" />
                  <UncontrolledTooltip target="ssAccountLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.ssAccount" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="ssCityLabel" for="social-security-benefits-ssCity">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.ssCity">Ss City</Translate>
                  </Label>
                  <AvField id="social-security-benefits-ssCity" type="text" name="ssCity" />
                  <UncontrolledTooltip target="ssCityLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.ssCity" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="ssStartMonthLabel" for="social-security-benefits-ssStartMonth">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.ssStartMonth">Ss Start Month</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="ssStartMonthLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.ssStartMonth" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="ssBaseLabel" for="social-security-benefits-ssBase">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.ssBase">Ss Base</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="ssBaseLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.ssBase" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="ssStopMonthLabel" for="social-security-benefits-ssStopMonth">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.ssStopMonth">Ss Stop Month</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="ssStopMonthLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.ssStopMonth" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="ssRemarkLabel" for="social-security-benefits-ssRemark">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.ssRemark">Ss Remark</Translate>
                  </Label>
                  <AvField id="social-security-benefits-ssRemark" type="text" name="ssRemark" />
                  <UncontrolledTooltip target="ssRemarkLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.ssRemark" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="allowanceLabel" for="social-security-benefits-allowance">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.allowance">Allowance</Translate>
                  </Label>
                  <AvField id="social-security-benefits-allowance" type="text" name="allowance" />
                  <UncontrolledTooltip target="allowanceLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.allowance" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="taxpayerLabel" for="social-security-benefits-taxpayer">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.taxpayer">Taxpayer</Translate>
                  </Label>
                  <AvField id="social-security-benefits-taxpayer" type="text" name="taxpayer" />
                  <UncontrolledTooltip target="taxpayerLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.taxpayer" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isSelfVerifyLabel" check>
                    ...
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.isSelfVerify">Is Self Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isSelfVerifyLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.isSelfVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isHrVerifyLabel" check>
                    ...
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.isHrVerify">Is Hr Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isHrVerifyLabel">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.help.isHrVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="social-security-benefits-pfType">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.pfType">Pf Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="social-security-benefits-pfStatus">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.pfStatus">Pf Status</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="social-security-benefits-providentPayScheme">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.providentPayScheme">Provident Pay Scheme</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label for="social-security-benefits-socialSecurityPayScheme">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.socialSecurityPayScheme">
                ...
                <AvGroup>
                  <Label for="social-security-benefits-ssStatus">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.ssStatus">Ss Status</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="social-security-benefits-laborType">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.laborType">Labor Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="social-security-benefits-taxerType">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.taxerType">Taxer Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="social-security-benefits-taxArea">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.taxArea">Tax Area</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="social-security-benefits-emp">
                    <Translate contentKey="rosterServer2App.socialSecurityBenefits.emp">Emp</Translate>
                  </Label>

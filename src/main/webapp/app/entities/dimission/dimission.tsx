    ...
    return (
      <div>
        <h2 id="dimission-heading">
          <Translate contentKey="rosterServer2App.dimission.home.title">Dimissions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.dimission.home.createLabel">Create new Dimission</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {dimissionList && dimissionList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('code')}>
                    <Translate contentKey="rosterServer2App.dimission.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('lastDate')}>
                    <Translate contentKey="rosterServer2App.dimission.lastDate">Last Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('reason')}>
                    <Translate contentKey="rosterServer2App.dimission.reason">Reason</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={this.sort('isHrVerify')}>
                    <Translate contentKey="rosterServer2App.dimission.isHrVerify">Is Hr Verify</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                  ...
                  <th>
                    <Translate contentKey="rosterServer2App.dimission.emp">Emp</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.dimission.home.notFound">No Dimissions found</Translate>
            </div>
          )}
        </div>

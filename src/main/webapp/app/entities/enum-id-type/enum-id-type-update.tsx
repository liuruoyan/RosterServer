    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumIdType.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumIdType.home.createOrEditLabel">Create or edit a EnumIdType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumIdTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-id-type-valuez">
                    <Translate contentKey="rosterServer2App.enumIdType.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-id-type-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-id-type-orderz">
                    <Translate contentKey="rosterServer2App.enumIdType.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="tenentCodeLabel" for="enum-id-type-tenentCode">
                    <Translate contentKey="rosterServer2App.enumIdType.tenentCode">Tenent Code</Translate>
                  </Label>
                  <AvField id="enum-id-type-tenentCode" type="text" name="tenentCode" />
                </AvGroup>
                <AvGroup>
                  <Label for="enum-id-type-parent">
                    <Translate contentKey="rosterServer2App.enumIdType.parent">Parent</Translate>
                  </Label>

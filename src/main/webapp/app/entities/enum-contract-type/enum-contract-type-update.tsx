    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumContractType.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumContractType.home.createOrEditLabel">Create or edit a EnumContractType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumContractTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-contract-type-valuez">
                    <Translate contentKey="rosterServer2App.enumContractType.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-contract-type-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-contract-type-orderz">
                    <Translate contentKey="rosterServer2App.enumContractType.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-contract-type-parent">
                    <Translate contentKey="rosterServer2App.enumContractType.parent">Parent</Translate>
                  </Label>

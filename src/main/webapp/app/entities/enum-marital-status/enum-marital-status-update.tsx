    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumMaritalStatus.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumMaritalStatus.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : enumMaritalStatusEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-marital-status-valuez">
                    <Translate contentKey="rosterServer2App.enumMaritalStatus.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-marital-status-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-marital-status-orderz">
                    <Translate contentKey="rosterServer2App.enumMaritalStatus.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-marital-status-parent">
                    <Translate contentKey="rosterServer2App.enumMaritalStatus.parent">Parent</Translate>
                  </Label>

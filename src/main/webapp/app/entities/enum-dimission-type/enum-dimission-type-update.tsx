    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumDimissionType.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumDimissionType.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : enumDimissionTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-dimission-type-valuez">
                    <Translate contentKey="rosterServer2App.enumDimissionType.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-dimission-type-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-dimission-type-orderz">
                    <Translate contentKey="rosterServer2App.enumDimissionType.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-dimission-type-parent">
                    <Translate contentKey="rosterServer2App.enumDimissionType.parent">Parent</Translate>
                  </Label>

    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumSsPayScheme.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumSsPayScheme.home.createOrEditLabel">Create or edit a EnumSsPayScheme</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumSsPaySchemeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-ss-pay-scheme-valuez">
                    <Translate contentKey="rosterServer2App.enumSsPayScheme.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-ss-pay-scheme-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-ss-pay-scheme-orderz">
                    <Translate contentKey="rosterServer2App.enumSsPayScheme.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-ss-pay-scheme-parent">
                    <Translate contentKey="rosterServer2App.enumSsPayScheme.parent">Parent</Translate>
                  </Label>

    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.additionalPost.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.additionalPost.home.createOrEditLabel">Create or edit a AdditionalPost</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : additionalPostEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="additional-post-code">
                    <Translate contentKey="rosterServer2App.additionalPost.code">Code</Translate>
                  </Label>
                  <AvField id="additional-post-code" type="text" name="code" />
                  <UncontrolledTooltip target="codeLabel">
                    <Translate contentKey="rosterServer2App.additionalPost.help.code" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="nameLabel" for="additional-post-name">
                    <Translate contentKey="rosterServer2App.additionalPost.name">Name</Translate>
                  </Label>
                  <AvField id="additional-post-name" type="text" name="name" />
                  <UncontrolledTooltip target="nameLabel">
                    <Translate contentKey="rosterServer2App.additionalPost.help.name" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="phoneLabel" for="additional-post-phone">
                    <Translate contentKey="rosterServer2App.additionalPost.phone">Phone</Translate>
                  </Label>
                  <AvField id="additional-post-phone" type="text" name="phone" />
                  <UncontrolledTooltip target="phoneLabel">
                    <Translate contentKey="rosterServer2App.additionalPost.help.phone" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="deptLabel" for="additional-post-dept">
                    <Translate contentKey="rosterServer2App.additionalPost.dept">Dept</Translate>
                  </Label>
                  <AvField id="additional-post-dept" type="text" name="dept" />
                  <UncontrolledTooltip target="deptLabel">
                    <Translate contentKey="rosterServer2App.additionalPost.help.dept" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="jobLabel" for="additional-post-job">
                    <Translate contentKey="rosterServer2App.additionalPost.job">Job</Translate>
                  </Label>
                  <AvField id="additional-post-job" type="text" name="job" />
                  <UncontrolledTooltip target="jobLabel">
                    <Translate contentKey="rosterServer2App.additionalPost.help.job" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="startDateLabel" for="additional-post-startDate">
                    <Translate contentKey="rosterServer2App.additionalPost.startDate">Start Date</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="startDateLabel">
                    <Translate contentKey="rosterServer2App.additionalPost.help.startDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="endDateLabel" for="additional-post-endDate">
                    <Translate contentKey="rosterServer2App.additionalPost.endDate">End Date</Translate>
                  </Label>
                  <AvField id="additional-post-endDate" type="date" className="form-control" name="endDate" />
                  <UncontrolledTooltip target="endDateLabel">
                    <Translate contentKey="rosterServer2App.additionalPost.help.endDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="remarkLabel" for="additional-post-remark">
                    <Translate contentKey="rosterServer2App.additionalPost.remark">Remark</Translate>
                  </Label>
                  <AvField id="additional-post-remark" type="text" name="remark" />
                  <UncontrolledTooltip target="remarkLabel">
                    <Translate contentKey="rosterServer2App.additionalPost.help.remark" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isSelfVerifyLabel" check>
                    ...
                    <Translate contentKey="rosterServer2App.additionalPost.isSelfVerify">Is Self Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isSelfVerifyLabel">
                    <Translate contentKey="rosterServer2App.additionalPost.help.isSelfVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isHrVerifyLabel" check>
                    <AvInput id="additional-post-isHrVerify" type="checkbox" className="form-control" name="isHrVerify" />
                    <Translate contentKey="rosterServer2App.additionalPost.isHrVerify">Is Hr Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isHrVerifyLabel">
                    <Translate contentKey="rosterServer2App.additionalPost.help.isHrVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="additional-post-emp">
                    <Translate contentKey="rosterServer2App.additionalPost.emp">Emp</Translate>
                  </Label>

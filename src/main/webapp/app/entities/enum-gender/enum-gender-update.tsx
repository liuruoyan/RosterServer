    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumGender.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumGender.home.createOrEditLabel">Create or edit a EnumGender</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumGenderEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-gender-valuez">
                    <Translate contentKey="rosterServer2App.enumGender.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-gender-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-gender-orderz">
                    <Translate contentKey="rosterServer2App.enumGender.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="tenentCodeLabel" for="enum-gender-tenentCode">
                    <Translate contentKey="rosterServer2App.enumGender.tenentCode">Tenent Code</Translate>
                  </Label>
                  <AvField id="enum-gender-tenentCode" type="text" name="tenentCode" />
                </AvGroup>
                <AvGroup>
                  <Label for="enum-gender-parent">
                    <Translate contentKey="rosterServer2App.enumGender.parent">Parent</Translate>
                  </Label>

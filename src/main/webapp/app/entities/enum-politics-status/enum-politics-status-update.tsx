    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumPoliticsStatus.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumPoliticsStatus.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : enumPoliticsStatusEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-politics-status-valuez">
                    <Translate contentKey="rosterServer2App.enumPoliticsStatus.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-politics-status-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-politics-status-orderz">
                    <Translate contentKey="rosterServer2App.enumPoliticsStatus.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-politics-status-parent">
                    <Translate contentKey="rosterServer2App.enumPoliticsStatus.parent">Parent</Translate>
                  </Label>

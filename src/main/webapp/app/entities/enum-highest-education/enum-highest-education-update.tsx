    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumHighestEducation.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumHighestEducation.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : enumHighestEducationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-highest-education-valuez">
                    <Translate contentKey="rosterServer2App.enumHighestEducation.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-highest-education-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-highest-education-orderz">
                    <Translate contentKey="rosterServer2App.enumHighestEducation.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-highest-education-parent">
                    <Translate contentKey="rosterServer2App.enumHighestEducation.parent">Parent</Translate>
                  </Label>

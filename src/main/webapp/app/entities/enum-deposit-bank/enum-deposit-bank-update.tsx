    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumDepositBank.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumDepositBank.home.createOrEditLabel">Create or edit a EnumDepositBank</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumDepositBankEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-deposit-bank-valuez">
                    <Translate contentKey="rosterServer2App.enumDepositBank.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-deposit-bank-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-deposit-bank-orderz">
                    <Translate contentKey="rosterServer2App.enumDepositBank.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-deposit-bank-parent">
                    <Translate contentKey="rosterServer2App.enumDepositBank.parent">Parent</Translate>
                  </Label>

    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumAccountType.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumAccountType.home.createOrEditLabel">Create or edit a EnumAccountType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumAccountTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-account-type-valuez">
                    <Translate contentKey="rosterServer2App.enumAccountType.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-account-type-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-account-type-orderz">
                    <Translate contentKey="rosterServer2App.enumAccountType.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-account-type-parent">
                    <Translate contentKey="rosterServer2App.enumAccountType.parent">Parent</Translate>
                  </Label>

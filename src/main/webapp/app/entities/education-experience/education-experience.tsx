    ...
    return (
      <div>
        <h2 id="education-experience-heading">
          <Translate contentKey="rosterServer2App.educationExperience.home.title">Education Experiences</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.educationExperience.home.createLabel">Create new Education Experience</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {educationExperienceList && educationExperienceList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('code')}>
                    <Translate contentKey="rosterServer2App.educationExperience.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="rosterServer2App.educationExperience.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('phone')}>
                    <Translate contentKey="rosterServer2App.educationExperience.phone">Phone</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('school')}>
                    <Translate contentKey="rosterServer2App.educationExperience.school">School</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('major')}>
                    <Translate contentKey="rosterServer2App.educationExperience.major">Major</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('inDate')}>
                    <Translate contentKey="rosterServer2App.educationExperience.inDate">In Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th>
                    <Translate contentKey="rosterServer2App.educationExperience.emp">Emp</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.educationExperience.home.notFound">No Education Experiences found</Translate>
            </div>
          )}
        </div>

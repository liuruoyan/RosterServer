    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumEmpTaxArea.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumEmpTaxArea.home.createOrEditLabel">Create or edit a EnumEmpTaxArea</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumEmpTaxAreaEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-emp-tax-area-valuez">
                    <Translate contentKey="rosterServer2App.enumEmpTaxArea.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-emp-tax-area-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-emp-tax-area-orderz">
                    <Translate contentKey="rosterServer2App.enumEmpTaxArea.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-emp-tax-area-parent">
                    <Translate contentKey="rosterServer2App.enumEmpTaxArea.parent">Parent</Translate>
                  </Label>

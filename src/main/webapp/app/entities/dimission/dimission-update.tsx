    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.dimission.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.dimission.home.createOrEditLabel">Create or edit a Dimission</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : dimissionEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="dimission-code">
                    <Translate contentKey="rosterServer2App.dimission.code">Code</Translate>
                  </Label>
                  <AvField id="dimission-code" type="text" name="code" />
                  <UncontrolledTooltip target="codeLabel">
                    <Translate contentKey="rosterServer2App.dimission.help.code" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="lastDateLabel" for="dimission-lastDate">
                    <Translate contentKey="rosterServer2App.dimission.lastDate">Last Date</Translate>
                  </Label>
                  <AvField id="dimission-lastDate" type="date" className="form-control" name="lastDate" />
                  <UncontrolledTooltip target="lastDateLabel">
                    <Translate contentKey="rosterServer2App.dimission.help.lastDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="reasonLabel" for="dimission-reason">
                    <Translate contentKey="rosterServer2App.dimission.reason">Reason</Translate>
                  </Label>
                  <AvField id="dimission-reason" type="text" name="reason" />
                  <UncontrolledTooltip target="reasonLabel">
                    <Translate contentKey="rosterServer2App.dimission.help.reason" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isSelfVerifyLabel" check>
                    <AvInput id="dimission-isSelfVerify" type="checkbox" className="form-control" name="isSelfVerify" />
                    <Translate contentKey="rosterServer2App.dimission.isSelfVerify">Is Self Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isSelfVerifyLabel">
                    <Translate contentKey="rosterServer2App.dimission.help.isSelfVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isHrVerifyLabel" check>
                    <AvInput id="dimission-isHrVerify" type="checkbox" className="form-control" name="isHrVerify" />
                    <Translate contentKey="rosterServer2App.dimission.isHrVerify">Is Hr Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isHrVerifyLabel">
                    <Translate contentKey="rosterServer2App.dimission.help.isHrVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="dimission-dimissionType">
                    <Translate contentKey="rosterServer2App.dimission.dimissionType">Dimission Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="dimission-emp">
                    <Translate contentKey="rosterServer2App.dimission.emp">Emp</Translate>
                  </Label>

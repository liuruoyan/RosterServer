  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="rosterServer2App.enumPfPayScheme.delete.question">
          <Translate contentKey="rosterServer2App.enumPfPayScheme.delete.question" interpolate={{ id: enumPfPaySchemeEntity.id }}>

...
public class EnumGenderResource {
    ...
    public ResponseEntity<List<EnumGenderDTO>> getAllEnumGenders(EnumGenderCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

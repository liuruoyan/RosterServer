    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.contract.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.contract.home.createOrEditLabel">Create or edit a Contract</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : contractEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="contract-code">
                    <Translate contentKey="rosterServer2App.contract.code">Code</Translate>
                  </Label>
                  <AvField id="contract-code" type="text" name="code" />
                  <UncontrolledTooltip target="codeLabel">
                    <Translate contentKey="rosterServer2App.contract.help.code" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="startDateLabel" for="contract-startDate">
                    <Translate contentKey="rosterServer2App.contract.startDate">Start Date</Translate>
                  </Label>
                  <AvField id="contract-startDate" type="date" className="form-control" name="startDate" />
                  <UncontrolledTooltip target="startDateLabel">
                    <Translate contentKey="rosterServer2App.contract.help.startDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="endDateLabel" for="contract-endDate">
                    <Translate contentKey="rosterServer2App.contract.endDate">End Date</Translate>
                  </Label>
                  <AvField id="contract-endDate" type="date" className="form-control" name="endDate" />
                  <UncontrolledTooltip target="endDateLabel">
                    <Translate contentKey="rosterServer2App.contract.help.endDate" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="emailLabel" for="contract-email">
                    <Translate contentKey="rosterServer2App.contract.email">Email</Translate>
                  </Label>
                  <AvField id="contract-email" type="text" name="email" />
                  <UncontrolledTooltip target="emailLabel">
                    <Translate contentKey="rosterServer2App.contract.help.email" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="workTelLabel" for="contract-workTel">
                    <Translate contentKey="rosterServer2App.contract.workTel">Work Tel</Translate>
                  </Label>
                  <AvField id="contract-workTel" type="text" name="workTel" />
                  <UncontrolledTooltip target="workTelLabel">
                    <Translate contentKey="rosterServer2App.contract.help.workTel" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="probationEndDayLabel" for="contract-probationEndDay">
                    <Translate contentKey="rosterServer2App.contract.probationEndDay">Probation End Day</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="probationEndDayLabel">
                    <Translate contentKey="rosterServer2App.contract.help.probationEndDay" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="probationLengthLabel" for="contract-probationLength">
                    <Translate contentKey="rosterServer2App.contract.probationLength">Probation Length</Translate>
                  </Label>
                  ...
                  <UncontrolledTooltip target="probationLengthLabel">
                    <Translate contentKey="rosterServer2App.contract.help.probationLength" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="otherLabel" for="contract-other">
                    <Translate contentKey="rosterServer2App.contract.other">Other</Translate>
                  </Label>
                  <AvField id="contract-other" type="text" name="other" />
                  <UncontrolledTooltip target="otherLabel">
                    <Translate contentKey="rosterServer2App.contract.help.other" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isSelfVerifyLabel" check>
                    <AvInput id="contract-isSelfVerify" type="checkbox" className="form-control" name="isSelfVerify" />
                    <Translate contentKey="rosterServer2App.contract.isSelfVerify">Is Self Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isSelfVerifyLabel">
                    <Translate contentKey="rosterServer2App.contract.help.isSelfVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isHrVerifyLabel" check>
                    <AvInput id="contract-isHrVerify" type="checkbox" className="form-control" name="isHrVerify" />
                    <Translate contentKey="rosterServer2App.contract.isHrVerify">Is Hr Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isHrVerifyLabel">
                    <Translate contentKey="rosterServer2App.contract.help.isHrVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="contract-contractType">
                    <Translate contentKey="rosterServer2App.contract.contractType">Contract Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="contract-emp">
                    <Translate contentKey="rosterServer2App.contract.emp">Emp</Translate>
                  </Label>

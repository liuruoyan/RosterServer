    ...
    return (
      <div>
        <h2 id="enum-emp-tax-area-heading">
          <Translate contentKey="rosterServer2App.enumEmpTaxArea.home.title">Enum Emp Tax Areas</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.enumEmpTaxArea.home.createLabel">Create new Enum Emp Tax Area</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {enumEmpTaxAreaList && enumEmpTaxAreaList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('valuez')}>
                    <Translate contentKey="rosterServer2App.enumEmpTaxArea.valuez">Valuez</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('orderz')}>
                    <Translate contentKey="rosterServer2App.enumEmpTaxArea.orderz">Orderz</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('tenentCode')}>
                    <Translate contentKey="rosterServer2App.enumEmpTaxArea.tenentCode">Tenent Code</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="rosterServer2App.enumEmpTaxArea.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.enumEmpTaxArea.home.notFound">No Enum Emp Tax Areas found</Translate>
            </div>
          )}
        </div>

    ...
    return (
      <div>
        <h2 id="direct-supervisor-heading">
          <Translate contentKey="rosterServer2App.directSupervisor.home.title">Direct Supervisors</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.directSupervisor.home.createLabel">Create new Direct Supervisor</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {directSupervisorList && directSupervisorList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('code')}>
                    <Translate contentKey="rosterServer2App.directSupervisor.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="rosterServer2App.directSupervisor.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('phone')}>
                    <Translate contentKey="rosterServer2App.directSupervisor.phone">Phone</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th>
                    <Translate contentKey="rosterServer2App.directSupervisor.emp">Emp</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.directSupervisor.home.notFound">No Direct Supervisors found</Translate>
            </div>
          )}
        </div>

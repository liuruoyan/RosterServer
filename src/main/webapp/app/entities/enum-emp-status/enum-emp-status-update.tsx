    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.enumEmpStatus.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.enumEmpStatus.home.createOrEditLabel">Create or edit a EnumEmpStatus</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : enumEmpStatusEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="valuezLabel" for="enum-emp-status-valuez">
                    <Translate contentKey="rosterServer2App.enumEmpStatus.valuez">Valuez</Translate>
                  </Label>
                  <AvField id="enum-emp-status-valuez" type="text" name="valuez" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderzLabel" for="enum-emp-status-orderz">
                    <Translate contentKey="rosterServer2App.enumEmpStatus.orderz">Orderz</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="enum-emp-status-parent">
                    <Translate contentKey="rosterServer2App.enumEmpStatus.parent">Parent</Translate>
                  </Label>

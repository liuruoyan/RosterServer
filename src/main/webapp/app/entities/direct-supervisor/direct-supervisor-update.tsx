    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rosterServer2App.directSupervisor.home.createOrEditLabel">
              <Translate contentKey="rosterServer2App.directSupervisor.home.createOrEditLabel">Create or edit a DirectSupervisor</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : directSupervisorEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="codeLabel" for="direct-supervisor-code">
                    <Translate contentKey="rosterServer2App.directSupervisor.code">Code</Translate>
                  </Label>
                  <AvField id="direct-supervisor-code" type="text" name="code" />
                  <UncontrolledTooltip target="codeLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.code" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="nameLabel" for="direct-supervisor-name">
                    <Translate contentKey="rosterServer2App.directSupervisor.name">Name</Translate>
                  </Label>
                  <AvField id="direct-supervisor-name" type="text" name="name" />
                  <UncontrolledTooltip target="nameLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.name" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="phoneLabel" for="direct-supervisor-phone">
                    <Translate contentKey="rosterServer2App.directSupervisor.phone">Phone</Translate>
                  </Label>
                  <AvField id="direct-supervisor-phone" type="text" name="phone" />
                  <UncontrolledTooltip target="phoneLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.phone" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="aSupNameLabel" for="direct-supervisor-aSupName">
                    <Translate contentKey="rosterServer2App.directSupervisor.aSupName">A Sup Name</Translate>
                  </Label>
                  <AvField id="direct-supervisor-aSupName" type="text" name="aSupName" />
                  <UncontrolledTooltip target="aSupNameLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.aSupName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="aSupPhoneLabel" for="direct-supervisor-aSupPhone">
                    <Translate contentKey="rosterServer2App.directSupervisor.aSupPhone">A Sup Phone</Translate>
                  </Label>
                  <AvField id="direct-supervisor-aSupPhone" type="text" name="aSupPhone" />
                  <UncontrolledTooltip target="aSupPhoneLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.aSupPhone" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="bSupNameLabel" for="direct-supervisor-bSupName">
                    <Translate contentKey="rosterServer2App.directSupervisor.bSupName">B Sup Name</Translate>
                  </Label>
                  <AvField id="direct-supervisor-bSupName" type="text" name="bSupName" />
                  <UncontrolledTooltip target="bSupNameLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.bSupName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="bSupPhoneLabel" for="direct-supervisor-bSupPhone">
                    <Translate contentKey="rosterServer2App.directSupervisor.bSupPhone">B Sup Phone</Translate>
                  </Label>
                  <AvField id="direct-supervisor-bSupPhone" type="text" name="bSupPhone" />
                  <UncontrolledTooltip target="bSupPhoneLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.bSupPhone" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="fSubNameLabel" for="direct-supervisor-fSubName">
                    <Translate contentKey="rosterServer2App.directSupervisor.fSubName">F Sub Name</Translate>
                  </Label>
                  <AvField id="direct-supervisor-fSubName" type="text" name="fSubName" />
                  <UncontrolledTooltip target="fSubNameLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.fSubName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="fSubPhoneLabel" for="direct-supervisor-fSubPhone">
                    <Translate contentKey="rosterServer2App.directSupervisor.fSubPhone">F Sub Phone</Translate>
                  </Label>
                  <AvField id="direct-supervisor-fSubPhone" type="text" name="fSubPhone" />
                  <UncontrolledTooltip target="fSubPhoneLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.fSubPhone" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isSelfVerifyLabel" check>
                    ...
                    <Translate contentKey="rosterServer2App.directSupervisor.isSelfVerify">Is Self Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isSelfVerifyLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.isSelfVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="isHrVerifyLabel" check>
                    ...
                    <Translate contentKey="rosterServer2App.directSupervisor.isHrVerify">Is Hr Verify</Translate>
                  </Label>
                  <UncontrolledTooltip target="isHrVerifyLabel">
                    <Translate contentKey="rosterServer2App.directSupervisor.help.isHrVerify" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label for="direct-supervisor-emp">
                    <Translate contentKey="rosterServer2App.directSupervisor.emp">Emp</Translate>
                  </Label>

    ...
    return (
      <div>
        <h2 id="enum-emp-status-heading">
          <Translate contentKey="rosterServer2App.enumEmpStatus.home.title">Enum Emp Statuses</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterServer2App.enumEmpStatus.home.createLabel">Create new Enum Emp Status</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {enumEmpStatusList && enumEmpStatusList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('valuez')}>
                    <Translate contentKey="rosterServer2App.enumEmpStatus.valuez">Valuez</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('orderz')}>
                    <Translate contentKey="rosterServer2App.enumEmpStatus.orderz">Orderz</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('tenentCode')}>
                    <Translate contentKey="rosterServer2App.enumEmpStatus.tenentCode">Tenent Code</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="rosterServer2App.enumEmpStatus.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="rosterServer2App.enumEmpStatus.home.notFound">No Enum Emp Statuses found</Translate>
            </div>
          )}
        </div>

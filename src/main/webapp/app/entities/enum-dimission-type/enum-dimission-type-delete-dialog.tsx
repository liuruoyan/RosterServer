  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="rosterServer2App.enumDimissionType.delete.question">
          <Translate contentKey="rosterServer2App.enumDimissionType.delete.question" interpolate={{ id: enumDimissionTypeEntity.id }}>
